...
public class HashCodeBuilder implements Builder<Integer> {
     ...
     * @since 2.3
     */
    private static final ThreadLocal<Set<ckmbks.framework.builder.IDKey>> REGISTRY = new ThreadLocal<Set<ckmbks.framework.builder.IDKey>>();
     ...
     * @since 2.3
     */
    static Set<ckmbks.framework.builder.IDKey> getRegistry() {
        return REGISTRY.get();
    }
    ...
    static boolean isRegistered(final Object value) {
        final Set<ckmbks.framework.builder.IDKey> registry = getRegistry();
        return registry != null && registry.contains(new ckmbks.framework.builder.IDKey(value));
    }
    ...
    static void register(final Object value) {
        synchronized (HashCodeBuilder.class) {
            if (getRegistry() == null) {
                REGISTRY.set(new HashSet<ckmbks.framework.builder.IDKey>());
            }
        }
        getRegistry().add(new ckmbks.framework.builder.IDKey(value));
    }
    ...
    static void unregister(final Object value) {
        Set<ckmbks.framework.builder.IDKey> registry = getRegistry();
        if (registry != null) {
            registry.remove(new ckmbks.framework.builder.IDKey(value));
            synchronized (HashCodeBuilder.class) {
                //read again
