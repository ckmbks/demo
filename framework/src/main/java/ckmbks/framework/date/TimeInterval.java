...
public class TimeInterval {
	 ...
	 */
	public long start() {
		time = ckmbks.framework.date.DateUtil.current(isNano);
		return time;
	}
	...
	public long intervalRestart() {
		long now = ckmbks.framework.date.DateUtil.current(isNano);
		long d = now - time;
		time = now;
		return d;
	}
	...
	public long intervalSecond(){
		return intervalMs() / ckmbks.framework.date.DateUnit.SECOND.getMillis();
	}
	...
	public long intervalMinute(){
		return intervalMs() / ckmbks.framework.date.DateUnit.MINUTE.getMillis();
	}
	...
	public long intervalHour(){
		return intervalMs() / ckmbks.framework.date.DateUnit.HOUR.getMillis();
	}
	...
	public long intervalDay(){
		return intervalMs() / ckmbks.framework.date.DateUnit.DAY.getMillis();
	}
