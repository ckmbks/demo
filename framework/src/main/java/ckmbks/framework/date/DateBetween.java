...
import ckmbks.framework.date.BetweenFormater;
...
public class DateBetween {
	 ...
	 * @return 时长差
	 */
	public long between(ckmbks.framework.date.DateUnit unit) {
	...
	public long betweenMonth(boolean isReset) {
		final Calendar beginCal = ckmbks.framework.date.DateUtil.calendar(begin);
		final Calendar endCal = ckmbks.framework.date.DateUtil.calendar(end);
