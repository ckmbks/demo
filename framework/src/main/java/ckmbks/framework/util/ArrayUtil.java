...
import ckmbks.framework.collection.IterUtil;
...
public class ArrayUtil {
	...
	public static <T extends CharSequence> T[] removeEmpty(T[] array) {
		return filter(array, new Filter<T>() {
			...
			public boolean accept(T t) {
				return false == ckmbks.framework.util.StrUtil.isEmpty(t);
			}
		});
	}
	...
	public static <T extends CharSequence> T[] removeBlank(T[] array) {
		return filter(array, new Filter<T>() {
			@Override
			public boolean accept(T t) {
				return false == ckmbks.framework.util.StrUtil.isBlank(t);
			}
		});
	}
	...
	public static String[] nullToEmpty(String[] array) {
		return filter(array, new Editor<String>() {
			...
			public String edit(String t) {
				return null == t ? ckmbks.framework.util.StrUtil.EMPTY : t;
			}
		});
	}
	...
	public static int indexOfIgnoreCase(CharSequence[] array, CharSequence value) {
		if (null != array) {
			for (int i = 0; i < array.length; i++) {
				if (ckmbks.framework.util.StrUtil.equalsIgnoreCase(array[i], value)) {
					return i;
				}
			}
		}
	...
	public static <T> String join(T[] array, CharSequence conjunction, String prefix, String suffix) {
		...
		for (T item : array) {
			...
			if (ArrayUtil.isArray(item)) {
				...
				sb.append(ckmbks.framework.util.StrUtil.wrap(ckmbks.framework.util.StrUtil.toString(item), prefix, suffix));
			}
		}
		return sb.toString();
	}
