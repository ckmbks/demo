...
public class NumberUtil {
	...
	public static BigDecimal add(Number... values) {
		if (ckmbks.framework.util.ArrayUtil.isEmpty(values)) {
	...
	public static boolean isNumber(String str) {
		if (ckmbks.framework.util.StrUtil.isBlank(str)) {
			return false;
		}
	 ...
	 * @return 是否相同
	 * @since 3.2.1
	 * @see ckmbks.framework.util.CharUtil#equals(char, char, boolean)
	 */
	public static boolean equals(char c1, char c2, boolean ignoreCase) {
		return ckmbks.framework.util.CharUtil.equals(c1, c2, ignoreCase);
	}
	 ...
	 * @return 最小值
	 * @since 4.0.7
	 * @see ckmbks.framework.util.ArrayUtil#min(Comparable[])
	 */
	@SuppressWarnings("unchecked")
	public static <T extends Comparable<? super T>> T min(T... numberArray) {
		return ckmbks.framework.util.ArrayUtil.min(numberArray);
	}
	 ...
	 * @return 最小值
	 * @since 4.0.7
	 * @see ckmbks.framework.util.ArrayUtil#min(long...)
	 */
	 ...
	 * @return 最小值
	 * @since 4.0.7
	 * @see ckmbks.framework.util.ArrayUtil#min(int...)
	 */
	 ...
	 * @return 最小值
	 * @since 4.0.7
	 * @see ckmbks.framework.util.ArrayUtil#min(short...)
	 */
	 ...
	 * @return 最小值
	 * @since 4.0.7
	 * @see ckmbks.framework.util.ArrayUtil#min(double...)
	 */
	 ...
	 * @return 最小值
	 * @since 4.0.7
	 * @see ckmbks.framework.util.ArrayUtil#min(float...)
	 */
	 ...
	 * @return 最大值
	 * @since 4.0.7
	 * @see ckmbks.framework.util.ArrayUtil#max(Comparable[])
	 */
	@SuppressWarnings("unchecked")
	public static <T extends Comparable<? super T>> T max(T... numberArray) {
		return ckmbks.framework.util.ArrayUtil.max(numberArray);
	}
	 ...
	 * @return 最大值
	 * @since 4.0.7
	 * @see ckmbks.framework.util.ArrayUtil#max(long...)
	 */
	 ...
	 * @return 最大值
	 * @since 4.0.7
	 * @see ckmbks.framework.util.ArrayUtil#max(int...)
	 */
	 ...
	 * @return 最大值
	 * @since 4.0.7
	 * @see ckmbks.framework.util.ArrayUtil#max(short...)
	 */
	 ...
	 * @return 最大值
	 * @since 4.0.7
	 * @see ckmbks.framework.util.ArrayUtil#max(double...)
	 */
	 ...
	 * @return 最大值
	 * @since 4.0.7
	 * @see ckmbks.framework.util.ArrayUtil#max(float...)
	 */
	...
	public static BigInteger newBigInteger(String str) {
		str = ckmbks.framework.util.StrUtil.trimToNull(str);
		if (null == str) {
			return null;
		}
	...
	public static int parseInt(String number) throws NumberFormatException {
		if (ckmbks.framework.util.StrUtil.isBlank(number)) {
			return 0;
		}

		// 对于带小数转换为整数采取去掉小数的策略
		number = ckmbks.framework.util.StrUtil.subBefore(number, ckmbks.framework.util.CharUtil.DOT, false);
		if (ckmbks.framework.util.StrUtil.isEmpty(number)) {
			return 0;
		}

		if (ckmbks.framework.util.StrUtil.startWithIgnoreCase(number, "0x")) {
			// 0x04表示16进制数
	...
	public static long parseLong(String number) {
		...
		// 对于带小数转换为整数采取去掉小数的策略
		number = ckmbks.framework.util.StrUtil.subBefore(number, CharUtil.DOT, false);
		if (ckmbks.framework.util.StrUtil.isEmpty(number)) {
			return 0;
		}
