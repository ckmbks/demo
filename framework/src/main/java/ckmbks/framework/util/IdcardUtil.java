...
import ckmbks.framework.date.DatePattern;
...
public class IdcardUtil {
	...
	public static String convert15To18(String idCard) {
		...
		if (Validator.isNumber(idCard)) {
			...
			idCard18 = ckmbks.framework.util.StrUtil.builder().append(idCard.substring(0, 6)).append(sYear).append(idCard.substring(8));
			// 获取校验位
	...
	public static String[] isValidCard10(String idCard) {
		if(ckmbks.framework.util.StrUtil.isBlank(idCard)) {
			return null;
		}
	...
	public static boolean isValidTWCard(String idCard) {
		if(ckmbks.framework.util.StrUtil.isEmpty(idCard)) {
			return false;
		}
	 ...
	 * @return 隐藏后的身份证号码
	 * @since 3.2.2
	 * @see ckmbks.framework.util.StrUtil#hide(CharSequence, int, int)
	 */
	public static String hide(String idCard, int startInclude, int endExclude) {
		return ckmbks.framework.util.StrUtil.hide(idCard, startInclude, endExclude);
	}
