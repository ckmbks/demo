...
import ckmbks.framework.io.resource.Resource;
 ...
 * @since 4.1.0
 */
public class MultiResource implements ckmbks.framework.io.resource.Resource, Iterable<ckmbks.framework.io.resource.Resource>, Iterator<ckmbks.framework.io.resource.Resource> {

	private List<ckmbks.framework.io.resource.Resource> resources;
	private int cursor;
	 ...
	 */
	public MultiResource(ckmbks.framework.io.resource.Resource... resources) {
	 ...
	 */
	public MultiResource(Collection<ckmbks.framework.io.resource.Resource> resources) {
		if(resources instanceof List) {
			this.resources = (List<ckmbks.framework.io.resource.Resource>)resources;
		}else {
	...
	@Override
	public Iterator<ckmbks.framework.io.resource.Resource> iterator() {
	...
	@Override
	public ckmbks.framework.io.resource.Resource next() {
