...
import ckmbks.framework.io.watch.WatchException;
import ckmbks.framework.io.watch.Watcher;
import ckmbks.framework.io.watch.watchers.WatcherChain;
...
public class WatchMonitor extends Thread implements Closeable{
	...
	/** 监听器 */
	private ckmbks.framework.io.watch.Watcher watcher;
	/** 监听事件列表 */
	 ...
	 * @return {@link WatchMonitor}
	 */
	public WatchMonitor setWatcher(ckmbks.framework.io.watch.Watcher watcher){
