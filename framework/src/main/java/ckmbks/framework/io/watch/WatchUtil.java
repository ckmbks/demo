package ckmbks.framework.io.watch;
...
import ckmbks.framework.io.watch.WatchMonitor;
import ckmbks.framework.io.watch.Watcher;
...
public class WatchUtil {
	 ...
	 * 
	 * @param url URL
	 * @param watcher {@link ckmbks.framework.io.watch.Watcher}
	 * @return {@link WatchMonitor}
	 */
	public static WatchMonitor createAll(URL url, ckmbks.framework.io.watch.Watcher watcher) {
	 ...
	 * @return {@link WatchMonitor}
	 */
	public static WatchMonitor createAll(URL url, int maxDepth, ckmbks.framework.io.watch.Watcher watcher) {
	 ...
	 * @return {@link WatchMonitor}
	 */
	public static WatchMonitor createAll(URI uri, ckmbks.framework.io.watch.Watcher watcher) {
	 ...
	 * @return {@link WatchMonitor}
	 */
	public static WatchMonitor createAll(URI uri, int maxDepth, ckmbks.framework.io.watch.Watcher watcher) {
	 ...
	 * @return {@link WatchMonitor}
	 */
	public static WatchMonitor createAll(File file, ckmbks.framework.io.watch.Watcher watcher) {
	 ...
	 * @return {@link WatchMonitor}
	 */
	public static WatchMonitor createAll(File file, int maxDepth, ckmbks.framework.io.watch.Watcher watcher) {
	 ...
	 * @return {@link WatchMonitor}
	 */
	public static WatchMonitor createAll(String path, ckmbks.framework.io.watch.Watcher watcher) {
	 ...
	 * @return {@link WatchMonitor}
	 */
	public static WatchMonitor createAll(String path, int maxDepth, ckmbks.framework.io.watch.Watcher watcher) {
	 ...
	 * @return {@link WatchMonitor}
	 */
	public static WatchMonitor createAll(Path path, ckmbks.framework.io.watch.Watcher watcher) {
		return createAll(path, 0, watcher);
	}
