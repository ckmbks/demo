...
import ckmbks.framework.json.test.bean.JSONBean;
import ckmbks.framework.json.test.bean.Seq;
import ckmbks.framework.json.test.bean.UserA;
import ckmbks.framework.json.test.bean.UserB;
import ckmbks.framework.json.test.bean.UserWithMap;
import ckmbks.framework.json.test.bean.report.CaseReport;
import ckmbks.framework.json.test.bean.report.StepReport;
import ckmbks.framework.json.test.bean.report.SuiteReport;
