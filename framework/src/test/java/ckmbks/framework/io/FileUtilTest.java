...
public class FileUtilTest {
	...
	public void copyTest() throws Exception {
		File srcFile = FileUtil.file("test.csv");
		File destFile = FileUtil.file("test.copy.csv");
	...
	public void listFileNamesTest() {
		...
		Assert.assertTrue(names.contains("test.csv"));
	...
	public void getWebRootTest() {
		...
		Assert.assertEquals("framework", webRoot.getName());
	}
