...
public class StrUtilTest {
	...
	public void formatTest() {
		...
		String result = StrUtil.templateFormat(template, Dict.create().set("name", "张三").set("phone", "13888881111"));
		Assert.assertEquals("你好，我是张三，我的电话是：13888881111", result);
		
		String result2 = StrUtil.templateFormat(template, Dict.create().set("name", "张三").set("phone", null));
