...
import ckmbks.framework.io.resource.ClassPathResource;
import ckmbks.framework.io.resource.FileResource;
import ckmbks.framework.io.resource.NoResourceException;
...
public class ResourceUtil {
	...
	/**
	 * 获取{@link ckmbks.framework.io.resource.Resource} 资源对象<br>
	 * 如果提供路径为绝对路径，返回{@link ckmbks.framework.io.resource.FileResource}，否则返回{@link ClassPathResource}
	 * 
	 * @param path 路径，可以是绝对路径，也可以是相对路径
	 * @return {@link ckmbks.framework.io.resource.Resource} 资源对象
	 * @since 3.2.1
	 */
