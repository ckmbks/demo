...
import ckmbks.framework.exceptions.ValidateException;
import ckmbks.framework.lang.Assert;
import ckmbks.framework.lang.PatternPool;
...
public class Validator {
	...
	public static boolean isLetter(CharSequence value) {
		return StrUtil.isAllCharMatch(value, new ckmbks.framework.lang.Matcher<Character>() {
			@Override
	...
	public static boolean isBetween(Number value, Number min, Number max) {
		ckmbks.framework.lang.Assert.notNull(value);
		ckmbks.framework.lang.Assert.notNull(min);
		Assert.notNull(max);
