...
public class RuntimeUtil {
	...
	public static String execForStr(String... cmds) throws IORuntimeException {
		return execForStr(ckmbks.framework.util.CharsetUtil.systemCharset(), cmds);
	}
	...
	public static List<String> execForLines(String... cmds) throws IORuntimeException {
		return execForLines(ckmbks.framework.util.CharsetUtil.systemCharset(), cmds);
	}
	...
	public static Process exec(String... cmds) {
		if (ckmbks.framework.util.ArrayUtil.isEmpty(cmds)) {
		...
		if (1 == cmds.length) {
			...
			if (ckmbks.framework.util.StrUtil.isBlank(cmd)) {
				throw new NullPointerException("Command is empty !");
			}
			cmds = ckmbks.framework.util.StrUtil.splitToArray(cmd, ckmbks.framework.util.StrUtil.C_SPACE);
		}
	...
	public static Process exec(String[] envp, File dir, String... cmds) {
		...
		if (1 == cmds.length) {
			...
			cmds = ckmbks.framework.util.StrUtil.splitToArray(cmd, StrUtil.C_SPACE);
		}
		try {
	...
	public static List<String> getResultLines(Process process) {
		return getResultLines(process, ckmbks.framework.util.CharsetUtil.systemCharset());
	}
	...
	public static String getResult(Process process) {
		return getResult(process, ckmbks.framework.util.CharsetUtil.systemCharset());
	}
