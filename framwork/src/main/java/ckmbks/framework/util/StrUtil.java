...
import ckmbks.framework.comparator.VersionComparator;
import ckmbks.framework.convert.Convert;
import ckmbks.framework.lang.Assert;
import ckmbks.framework.lang.Func1;
import ckmbks.framework.lang.Matcher;
import ckmbks.framework.text.StrBuilder;
import ckmbks.framework.text.StrFormatter;
import ckmbks.framework.text.StrSpliter;
import ckmbks.framework.text.TextSimilarity;
...
public class StrUtil {
	 ...
	 * 例：<br>
	 * 通常使用：templateFormat("this is {} for {}", "a", "b") =》 this is a for b<br>
	 * 转义{}： templateFormat("this is \\{} for {}", "a", "b") =》 this is \{} for a<br>
	 * 转义\： templateFormat("this is \\\\{} for {}", "a", "b") =》 this is \a for b<br>
	 * 
	 * @param template 文本模板，被替换的部分用 {} 表示
	 * @param params 参数值
	 * @return 格式化后的文本
	 */
	public static String templateFormat(CharSequence template, Object... params) {
		if (null == template) {
			return null;
		}
	 ...
	 * 例：<br>
	 * 通常使用：templateFormat("this is {0} for {1}", "a", "b") =》 this is a for b<br>
	 * 
	 * @param pattern 文本格式
	 * @param arguments 参数
	 * @return 格式化后的文本
	 ...
	 * map = {a: "aValue", b: "bValue"} templateFormat("{a} and {b}", map) ---=》 aValue and bValue
	 * 
	 * @param template 文本模板，被替换的部分用 {key} 表示
	 * @param map 参数值对
	 * @return 格式化后的文本
	 */
	public static String templateFormat(CharSequence template, Map<?, ?> map) {
		if (null == template) {
			return null;
		}
	...
	public static String brief(CharSequence str, int maxLength) {
		...
		final String str2 = str.toString();
		return templateFormat("{}...{}", str2.substring(0, maxLength - w), str2.substring(l - w));
	}
	 ...
	 * @return 替换后的字符串
	 * @see ckmbks.framework.util.ReUtil#replaceAll(CharSequence, Pattern, Func1)
	 * @since 4.2.2
	 */
	public static String replace(CharSequence str, Pattern pattern, Func1<java.util.regex.Matcher, String> replaceFun) {
		return ckmbks.framework.util.ReUtil.replaceAll(str, pattern, replaceFun);
	}
	 ...
	 * @param replaceFun 决定如何替换的函数
	 * @return 替换后的字符串
	 * @see ckmbks.framework.util.ReUtil#replaceAll(CharSequence, String, Func1)
	 * @since 4.2.2
	 */
	 ...
	 * @return UUID字符串
	 * @since 4.0.10
	 * @see ckmbks.framework.util.IdUtil#randomUUID()
	 */
