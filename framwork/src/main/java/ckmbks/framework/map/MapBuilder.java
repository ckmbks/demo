...
public class MapBuilder<K, V>{
	...
	public String join(String separator, final String keyValueSeparator) {
		return ckmbks.framework.map.MapUtil.join(this.map, separator, keyValueSeparator);
	}
	...
	public String joinIgnoreNull(String separator, final String keyValueSeparator) {
		return ckmbks.framework.map.MapUtil.joinIgnoreNull(this.map, separator, keyValueSeparator);
	}
