...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
	...
	private static final ckmbks.framework.date.format.FormatCache<FastDateFormat> cache = new ckmbks.framework.date.format.FormatCache<FastDateFormat>(){
		@Override
