...
import ckmbks.framework.date.format.AbstractDateBasic;
import ckmbks.framework.date.format.DateParser;
import ckmbks.framework.date.format.FastDateFormat;
import ckmbks.framework.date.format.FastDatePrinter;
...
class FastDateParser extends AbstractDateBasic implements DateParser {
	 ...
	 * </p>
	 * 
	 * Use {@link ckmbks.framework.date.format.FastDateFormat#getInstance(String, TimeZone, Locale)} or another variation of the factory methods of {@link FastDateFormat} to get a cached FastDateParser instance.
	 *
