...
public class BetweenFormater {
	...
	public String format(){
		...
		if(betweenMs > 0){
			long day = betweenMs / ckmbks.framework.date.DateUnit.DAY.getMillis();
			long hour = betweenMs / ckmbks.framework.date.DateUnit.HOUR.getMillis() - day * 24;
			long minute = betweenMs / ckmbks.framework.date.DateUnit.MINUTE.getMillis() - day * 24 * 60 - hour * 60;
