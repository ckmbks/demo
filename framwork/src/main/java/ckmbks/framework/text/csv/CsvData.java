...
public final class CsvData {
	...
	private final List<ckmbks.framework.text.csv.CsvRow> rows;

	public CsvData(final List<String> header, final List<ckmbks.framework.text.csv.CsvRow> rows) {
		this.header = header;
		this.rows = rows;
	}
	 ...
	 */
	public ckmbks.framework.text.csv.CsvRow getRow(final int index) {
