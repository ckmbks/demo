...
public class UnicodeUtil {
	...
	public static String toString(String unicode) {
		...
		ckmbks.framework.text.StrBuilder sb = ckmbks.framework.text.StrBuilder.create(len);
		int i = -1;
		int pos = 0;
	...
	public static String toUnicode(String str, boolean isSkipAscii) {
		...
		final ckmbks.framework.text.StrBuilder unicode = StrBuilder.create(str.length() * 6);
		char c;
		for (int i = 0; i < len; i++) {
			c = str.charAt(i);
