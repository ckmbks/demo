...
import ckmbks.framework.thread.RejectPolicy;
import ckmbks.framework.thread.ThreadFactoryBuilder;
...
public class ExecutorBuilder implements Builder<ThreadPoolExecutor> {
	 ...
	 * <p>
	 * 此处可以使用JDK预定义的几种策略，见{@link ckmbks.framework.thread.RejectPolicy}枚举
	 * 
